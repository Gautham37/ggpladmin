...
class PartyLedgerExport1 implements FromCollection,WithHeadings
{
    /**
 ...
 function __construct($start_date,$end_date,$market_id) {
    ...
    public function headings(): array
    {
        ...
        $data = TransactionTrack::select(
          ...
          $party_name = DB::table('markets')->select('name')->where('id',$this->market_id)->get();
         ...
         return [
           ...
           [],
           [],
           ['TRANSACTION NO','TRANSACTION TYPE','DATE','CREDIT','DEBIT'],
        ];
    }
}
