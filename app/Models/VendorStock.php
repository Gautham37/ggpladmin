...
class VendorStock extends Model implements HasMedia
{
    use HasFactory;
    ...
    {
        return $this->hasMany(VendorStockItems::class, 'vendor_stock_id');
    }
