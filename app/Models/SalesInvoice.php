...
class SalesInvoice extends Model implements HasMedia
{
    ...
    {
        return $this->belongsTo(\App\Models\LoyalityPoints::class, 'id', 'sales_invoice_id');
    }

    public function redeempoints()
    {
        return $this->belongsTo(\App\Models\LoyalityPoints::class, 'id', 'sales_invoice_id')->where('type','redeem');
    }

    public function amountsettle()
    {
        return $this->hasMany(PaymentInSettle::class, 'sales_invoice_id');
    }
    ...
    {
        return $this->belongsTo(\App\Models\SalesReturn::class, 'id', 'sales_invoice_id');
    }
