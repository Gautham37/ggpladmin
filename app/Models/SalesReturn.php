...
class SalesReturn extends Model implements HasMedia
{
    use HasFactory;
    ...
    {
        return $this->hasMany(SalesReturnItems::class, 'sales_return_id');
    }

    public function amountsettle()
    {
        return $this->hasMany(PaymentOutSettle::class, 'sales_return_id');
    }
