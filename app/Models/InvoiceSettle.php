 ...
 */
class InvoiceSettle extends Model implements HasMedia
{
     ...
     */
    public static $rules = [
        'payment_out_id' => 'required',
        'invoice_settle_type' => 'required',
        'invoice_settle_invoice_id' => 'required',
        'invoice_settle_date' => 'required',
        'invoice_settle_amount' => 'required|numeric|min:0',
        
    ];

    public $table = 'invoice_settle';
    public $fillable = [
        'payment_out_id',
        'invoice_settle_type',
    ...
    protected $casts = [
        ...
        'invoice_settle_type' => 'string',
        'invoice_settle_invoice_id' => 'integer',
        'invoice_settle_date' => 'string',
        'invoice_settle_amount'  => 'double',
        'created_by' => 'integer',
        'updated_by' => 'integer',
    ];
    /**
