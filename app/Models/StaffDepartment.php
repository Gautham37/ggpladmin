...
class StaffDepartment extends Model implements HasMedia
{
     ...
     */
    public static $rules = [
        //'name' => 'required|unique:staffdepartments',
        'name' => 'required',
        'prefix'=> 'required',
...
//    }
    ...
    public function markets()
    {
     ...
     public function staffdesignations(){
        return $this->hasMany(\App\Models\StaffDesignation::class, 'department_id');
    }
