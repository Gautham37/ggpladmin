...
class PurchaseInvoice extends Model implements HasMedia
{
    ...
    {
        return $this->hasMany(PaymentOutSettle::class, 'purchase_invoice_id');
    }

    public function totalsettle($type,$column_name,$column_value) {
        return PaymentOutSettle::where($column_name,$column_value)->where('settle_type',$type)->sum('amount');
    }

    public function puchaseorder()
    {
        return $this->belongsTo(\App\Models\PurchaseOrder::class, 'id', 'purchase_order_id');
    }

    public function vendorstock()
    {
        return $this->belongsTo(\App\Models\VendorStock::class, 'id', 'vendor_stock_id');
    }

    public function purchasereturn()
    {
        return $this->belongsTo(\App\Models\PurchaseReturn::class, 'id', 'purchase_invoice_id');
    }
