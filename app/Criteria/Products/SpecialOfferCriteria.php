...
/**
 * Class SpecialOfferCriteria.
 *
 * @package namespace App\Criteria\Products;
 */
class SpecialOfferCriteria implements CriteriaInterface
{
    /**
     * @var array
     */
    ...
    /**
     * SpecialOfferCriteria constructor.
     */
    ...
    {
        return $model->where('discount_price','>','0')->where('online_store','1')->where('stock','>','0');
