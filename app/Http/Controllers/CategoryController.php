...
private $uploadRepository;
    ...
    public function __construct(CategoryRepository $categoryRepo, DepartmentsRepository $departmentsRepo, CustomFieldRepository $customFieldRepo , UploadRepository $uploadRepo)
    {
        parent::__construct();
    ...
    public function create()
    {
        ...
        return view('categories.create')->with("departments", $departments)->with("customFields", isset($html) ? $html : false);
    }
    ...
    public function edit($id)
    {
        ...
        return view('categories.edit')->with("departments", $departments)->with('category', $category)->with("customFields", isset($html) ? $html : false);
    }
