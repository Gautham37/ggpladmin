...
class CouponController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('coupons.create')
                    ...
                    //->with("market", $market)
                    ->with("category", $category)->with("productsSelected", $productsSelected)
    ...
    public function store(CreateCouponRequest $request)
    {
        $input = $request->all();
         ...
         $input['expires_at'] = Carbon::createFromFormat('d-m-Y', $request->expires_at)->format('Y-m-d');
    ...
    public function update($id, UpdateCouponRequest $request)
    {
        ...
        $input = $request->all();
        $input['expires_at'] = Carbon::parse($request->expires_at)->format('Y-m-d');
        unset($input['code']);
