...
use App\DataTables\LoyalityPointDataTable;
...
private $uploadRepository;
    ...
    public function __construct(LoyalityPointsRepository $loyalityPointsRepo, CustomFieldRepository $customFieldRepo , UploadRepository $uploadRepo)
    {
        parent::__construct();
        $this->loyalityPointRepository = $loyalityPointsRepo;
     ...
     * @return Response
     */
    public function index(LoyalityPointDataTable $loyalityPointDataTable)
    {
        return $loyalityPointDataTable->render('loyality_points.index');
    }
