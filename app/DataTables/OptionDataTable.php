...
class OptionDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'name',
                'title' => trans('lang.option_name'),'width'=> '10%'

            ],
            [
                'data' => 'image',
                'title' => trans('lang.option_image'),
                'searchable' => false, 'orderable' => false, 'exportable' => false, 'printable' => false, 'className' => "text-center",'width'=> '8%'
            ],
            [
                'data' => 'price',
                'title' => trans('lang.option_price'), 'className' => "text-center",'width'=> '10%'
            ...
            [
                ...
                'title' => trans('lang.option_group'),'width'=> '15%'
