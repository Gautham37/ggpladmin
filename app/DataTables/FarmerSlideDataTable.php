...
class FarmerSlideDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->addColumn('action', 'farmer_slides.datatables_actions')
     ...
     */
    public function query(FarmerSlide $model)
    {
    ...
    {
        return 'farmerslidesdatatable_' . time();
    }
}