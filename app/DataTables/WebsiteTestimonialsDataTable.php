...
class WebsiteTestimonialsDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->addColumn('action', 'settings.testimonials.datatables_actions')
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'rating',
                'title' => trans('lang.testimonial_rating'),
        ...
        $hasCustomField = in_array(WebsiteTestimonials::class, setting('custom_field_models', []));
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', WebsiteTestimonials::class)->where('in_table', '=', true)->get();
     ...
     */
    public function query(WebsiteTestimonials $model)
    {
