...
class ProductColorsDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
           ->addIndexColumn()
            ->editColumn('created_at', function ($product_color) {
                return getDateColumn($product_color, 'created_at');
            })
            ->addColumn('action', 'product_colors.datatables_actions')
     ...
     */
    public function query(ProductColors $model)
    {   
    ...
    {
        return 'productcolorsdatatable_' . time();
    }
}