...
class EarningDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'total_orders',
                'title' => trans('lang.earning_total_orders'), 'className' => "text-center",

            ],
            [
                'data' => 'total_earning',
                'title' => trans('lang.earning_total_earning'), 'className' => "text-center"

            ],
            [
                'data' => 'admin_earning',
                'title' => trans('lang.earning_admin_earning'), 'className' => "text-center"

            ],
            [
                'data' => 'market_earning',
                'title' => trans('lang.earning_market_earning'), 'className' => "text-center"

            ],
            [
                'data' => 'delivery_fee',
                'title' => trans('lang.earning_delivery_fee'), 'className' => "text-center"

            ],
            [
                'data' => 'tax',
                'title' => trans('lang.earning_tax'), 'className' => "text-center"
