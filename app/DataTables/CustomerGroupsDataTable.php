...
class CustomerGroupsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->addColumn('action', 'customer_groups.datatables_actions')
    ...
    protected function getColumns()
    {
        ...
        $hasCustomField = in_array(CustomerGroups::class, setting('custom_field_models', []));
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', CustomerGroups::class)->where('in_table', '=', true)->get();
     ...
     */
    public function query(CustomerGroups $model)
    {
    ...
    {
        return 'customergroupsdatatable_' . time();
    }
}