<?php
/**
 * File name: RateListDataTable.php
...
class RateListDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ->editColumn('purchase_price', function ($product) {
                return setting('default_currency').' '.$product['purchase_price'];
            })
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'purchase_price',
                'title' => trans('lang.product_purchase_price'),
                'searchable' => true, 'orderable' => true, 'exportable' => true, 'printable' => true,
            ],
            [
                'data' => 'price',
