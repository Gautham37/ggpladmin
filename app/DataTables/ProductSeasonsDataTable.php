...
class ProductSeasonsDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
           ->addIndexColumn()
            ->editColumn('created_at', function ($product_season) {
                return getDateColumn($product_season, 'created_at');
            })
            ->addColumn('action', 'product_seasons.datatables_actions')
     ...
     */
    public function query(ProductSeasons $model)
    {   
    ...
    {
        return 'productseasonsdatatable_' . time();
    }
}