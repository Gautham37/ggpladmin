<?php
/**
 * File name: WebsiteSlideDataTable.php
...
class WebsiteSlideDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->addColumn('action', 'website_slides.datatables_actions')
    ...
    protected function getColumns()
    {
        ...
        $hasCustomField = in_array(WebsiteSlide::class, setting('custom_field_models', []));
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', WebsiteSlide::class)->where('in_table', '=', true)->get();
     ...
     */
    public function query(WebsiteSlide $model)
    {
    ...
    {
        return 'websiteslidesdatatable_' . time();
    }
}