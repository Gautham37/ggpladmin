...
class ProductStatusDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
           ->addIndexColumn()
            ->editColumn('created_at', function ($product_status) {
                return getDateColumn($product_status, 'created_at');
            })
            ->addColumn('action', 'product_status.datatables_actions')
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'status',
                'title' => trans('lang.product_status_status'),

            ],
            [
                'data' => 'created_at',
                'title' => trans('lang.product_status_created_at'),
                'searchable' => false,
            ]
        ];
    ...
    {
        return 'productstatusdatatable_' . time();
    }
}