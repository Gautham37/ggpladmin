<?php
/**
 * File name: ExpensesCategoryReportDataTable.php
...
class ExpensesCategoryReportDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable->editColumn('image', function ($expenses) {
    ...
    protected function getColumns()
    {
        $columns = [
            [
                'data' => 'name',
                'title' => 'CATEGORY',
                'exportable' => true, 'printable' => true,
            ],
            [
    ...
    {
        return 'expensescategoryreportdatatable_' . time();
    }
}