...
class ExpensesCategoryDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
           ...
           /* ->editColumn('image', function ($category) {
            ...
            ->addColumn('action', 'expenses_category.datatables_actions')
    ...
    protected function getColumns()
    {
        ...
        $hasCustomField = in_array(ExpensesCategory::class, setting('custom_field_models', []));
        if ($hasCustomField) {
            $customFieldsCollection = CustomField::where('custom_field_model', ExpensesCategory::class)->where('in_table', '=', true)->get();
    ...
    {
        return 'expensescategorydatatable_' . time();
    }
}