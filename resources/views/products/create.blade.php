   ...
   <div class="card">
      <div class="card-header">
         <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
            ...
            <!--<li class="nav-item">
               <a class="nav-link" href="" data-toggle="modal" data-target="#CategoryModal"><i class="fa fa-plus mr-2"></i>{{trans('lang.category_create')}}</a>
               </li>-->
         </ul>
      </div>
      <div class="card-body">
      ...
      @include('layouts.modal.department_modal')
      @include('layouts.modal.category_modal')
      @include('layouts.modal.subcategory_modal')
      @include('layouts.modal.quality_grade_modal')
      @include('layouts.modal.stock_status_modal')
      @include('layouts.modal.value_added_services_modal')

      @include('layouts.modal.season_modal')
      @include('layouts.modal.color_modal')
      @include('layouts.modal.nutrition_modal')
      @include('layouts.modal.taste_modal')
     ...
     $("#dropdownss").change(function() {
        ...
        // var drop_count = $("#dropdownss :selected").length;
         $("#textboxDiv").html('');
            $.ajax({
              type:'POST',
              url:"{{ route('products.createProductPrice') }}",
              data:{customer_group_id:selVal,"_token": "{{ csrf_token() }}",},
