    ...
    <div id="mid">
      <div id="table" style="display: flex;">
         ...
         <table style="width:50%;">
            <tr class="service">
               <td colspan="2" class="tableitem"><p class="itemtext">{{$purchase_return->paymentmethod->name}} Payment</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Bill To</p></td>
               <td class="tableitem"><p class="itemtext">{{$purchase_return->market->name}}</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Bill No</p></td>
               <td class="tableitem"><p class="itemtext">{{$purchase_return->code}}</p></td>
            </tr>
         </table>
         ...
         <table style="width:50%;">
            <tr class="service">
               ...
               <td class="tableitem"><p class="itemtext">{{$purchase_return->createdby->name}}</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Date</p></td>
               <td class="tableitem"><p class="itemtext">{{$purchase_return->date->format('d/m/Y')}}</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Time</p></td>
               <td class="tableitem"><p class="itemtext">{{$purchase_return->created_at->format('H:i:s')}}</p></td>
            </tr>
         </table>
               ...
               <div id="table">
                  <table>
                     ...
                     <tr class="tabletitle">
                        ...
                        <td class="payment text-right"><b>{{number_format($purchase_return->sub_total,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right">Discount</td>
                        <td class="payment text-right"><b>{{number_format($purchase_return->discount_total,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right">GST</td>
                        <td class="payment text-right"><b>{{number_format($purchase_return->tax_total,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right">Pickup Charge</td>
                        <td class="payment text-right"><b>{{number_format($purchase_return->delivery_charge,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right"><b>Net Amount</b></td>
                        <td class="payment text-right"><b>{{number_format($purchase_return->total,2,'.','')}}</b></td>
                     </tr>
