      ...
      <div class="invoice_page_original" style="font-size:12px;background-color:#f4f4f533;">
         <div class="invoice_page1">
            <table style="width: auto; background-color:#f4f4f533;">
               <tr>
                  <td style="border: 1px solid #000; padding: 3px;"><b>{{ trans('lang.purchase_return') }}</b></td>
               </tr>
            </table>
            ...
            <table style="width: 100%; line-height:15px;" class="pdf_div1" cellpadding="15">
               <tr>
                  <td width="33%">
                     <b>{{ trans('lang.purchase_return') }} : </b> {{$purchase_return->purchase_code}}
                  </td>
                  <td width="33%">
                     <b>{{ trans('lang.purchase_return') }} : </b> {{date('d-m-Y',strtotime($purchase_return->purchase_date))}}
                  </td>
                  <td width="33%">
                     <b>{{ trans('lang.po_expiry_date') }} : </b> {{date('d-m-Y',strtotime($purchase_return->purchase_valid_date))}}
                  </td>
               </tr>
            </table>
            <div class="pdf_whole" style="padding:20px;background-color:#f4f4f533;">
               ...
               <table class="pdf_list_original"  cellpadding="5">
                  <tr>
                     ...
                     <td width="12%" align="center" {!!$sty_pdf!!} > 
                          {!!$money_symbol!!}
                          <b>{{number_format($purchase_return->purchase_discount_amount,2)}}</b>
                     </td>
                     <td width="12%" align="center" {!!$sty_pdf!!} >
                          {!!$money_symbol!!}
                          <b>{{number_format($purchase_return->purchase_igst_amount,2)}}</b>
                     </td>
                     <td width="12%" align="center" {!!$sty_pdf!!} >
                          {!!$money_symbol!!}
                          <b>{{number_format($purchase_return->purchase_total_amount - $purchase_return->purchase_additional_charge,2)}}</b>
                     </td>
                  </tr>
                </table>
                ...
                <table style="width: 100%;">
                  ...
                  <tr>
                     ...
                     <td style="width: 15%;border:none;" align="right">
                       <b>{!!$money_symbol!!} {{number_format($purchase_return->purchase_taxable_amount,2)}}</b>
                     </td>
                  </tr>

                  <?php if($purchase_return->purchase_igst_amount!=0){ ?>
                  <tr>
                     <td style="width: 25%;border:none;"></td>
                     <td style="width: 35%;border:none;"></td>
                     <td style="width: 25%;border:none;" align="right">{{ trans('lang.po_sgst_amount')}}</td>
                     <td style="width: 15%;border:none;" align="right">
                          <b>{!!$money_symbol!!} {{number_format($purchase_return->purchase_sgst_amount,2)}}</b>
                     </td>
                  </tr>
                  <tr>
                     <td style="width: 25%;border:none;"></td>
                     ...
                     <td style="width: 15%;border:none;" align="right">
                          <b>{!!$money_symbol!!} {{number_format($purchase_return->purchase_cgst_amount,2)}}</b>
                     </td>
                  </tr>
                  <?php } ?>  

                  @if($purchase_return->purchase_additional_charge>0)   
                  <tr>
                     <td style="width: 25%;border:none;"></td>
                     <td style="width: 35%;border:none;"></td>
                     <td style="width: 25%;" align="right"> {{$purchase_return->purchase_additional_charge_description}}</td>
                     <td style="width: 15%;" align="right">
                          <b>{!!$money_symbol!!} {{number_format($purchase_return->purchase_additional_charge,2)}}</b>
                     </td>
                  </tr>
                  @endif
                  <tr >
                     ...
                     <td style="width: 15%;" align="right">
                          <b>{!!$money_symbol!!} {{number_format($purchase_return->purchase_round_off,2)}}</b>
                     </td>
                  </tr>
                  <tr>
                     <td style="width: 25%;border:none;"></td>
                     ...
                     <td style="width: 15%;border-top:2px solid #e9ecef;border-bottom:2px solid #e9ecef;" align="right">
                        <b>{!!$money_symbol!!} {{number_format(round($purchase_return->purchase_total_amount),2)}}</b>
                     </td>
                  </tr>
                  <?php
                     //net pay per annum in words
                     $number = round($purchase_return->purchase_total_amount);
                     $no = floor($number);
                  ...
                  <!--  <tr>
                     ...
                     <td style="width: 15%;border-top:2px solid #e9ecef;" align="right"><b><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{$purchase_return->purchase_total_amount}}</b></td>
                     </tr>   --> 
               </table>
               <!-- <table class="bank_info" style="width: 100%;line-height:12px;">
                  <?php $balance_amount = 0;//$balance_amount = $grand_total - {{$purchase_return->purchase_total_amount}}; ?>
               ...
               <table style="width: 100%;" cellpadding="5">
                  <tr style="line-height:20px;">
                     ...
                     <td width="50%" style="border:none; text-align: right;padding-top:10px;">
