    ...
    <div class="row">
      ...
      <div class="col-md-4 row">
          ...
          <div class="col-md-6">
            ...
            {!! Form::text('purchase_code', isset($purchase_return_no) ? $purchase_return_no : '' ,  ['class' => 'form-control']) !!}
          ...
          <div class="col-md-6">
            ...
            {!! Form::text('purchase_date', date('Y-m-d'),  ['class' => 'form-control datepicker', 'readonly' => 'readonly']) !!}
