    ...
    <div class="row" style="margin-top:20px;">
      ...
      <div class="col-md-4 mt-15">
          ...
          <div class="form-group row">
            ...
            {!! Form::text('purchase_code', isset($purchase_return_no) ? $purchase_return_no : '' ,  ['class' => 'col-md-8 form-control']) !!}
      ...
      <div class="col-md-4">
          <table class="table table-bordered">
            ...
            <tr>
              <td class="text-right">
                Cash Paid / 
                <span> Mark as Fully Paid  
                <input type="checkbox" name="mark_as_paid" id="mark_as_paid" value="1"></span>
                </span> 
              </td>
              <td class="text-right">
