  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link" href="{!! route('productTastes.index') !!}"><i class="fa fa-list mr-2"></i>Product Tastes List</a>
        </li>
        ...
        @endcan
        @can('productTastes.edit')
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-edit mr-2"></i>Edit Product Taste</a>
        </li>
        @endcan
      </ul>
    </div>
    ...
    <div class="card-body">
      {!! Form::model($product_taste, ['route' => ['productTastes.update', $product_taste->id], 'method' => 'patch']) !!}
      <div class="row">
        @include('product_tastes.fields')
      </div>
      {!! Form::close() !!}
      <div class="clearfix"></div>
    </div>
