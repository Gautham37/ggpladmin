...
<script type="text/javascript">
    ...
    function cb(start, end) {
        ...
        table.ajax.url("{{ url('reports/stockPurchaseReport') }}?start_date="+start_date+"&end_date="+end_date);
        table.ajax.reload();
    }
    ...
    $(document).on("click","#report",function() {
        ...
        location.href="exportReport?type="+type+"&report_type={{$report_type}}&start_date="+start_date+"&end_date="+end_date;  
