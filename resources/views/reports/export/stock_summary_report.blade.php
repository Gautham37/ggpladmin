...
<hr>
<p class="text-right"><b>{{trans('lang.report_stock_summary')}}</b></p>
<div class="detail-table">
    <span><b>Date : </b> {{date('d M Y')}} 
	<hr>
	<?php /*/ ?><b class="text-right">Total Stock Value : <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{ $stock_value }}</b> </p><?php /*/ ?>
</div>
...
<table class="report-table">
	...
	<tbody>
		...
		<tr>
			...
			<td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{$data->purchase_price}}</td>
			<td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{$data->price}}</td>
			<td>{{$data->stock}}</td>
