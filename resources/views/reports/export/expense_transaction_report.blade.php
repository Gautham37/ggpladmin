...
<hr>
<p class="text-right"><b>{{trans('lang.report_expense_transaction_report')}}</b></p>
<div class="detail-table">
	<span><b>Date : </b> {{date('d M Y', strtotime($start_date))}} - {{date('d M Y', strtotime($end_date))}} </span>
	<hr>
	<b class="text-right">Total Expense Amount : <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{ $total_expense }}</b> </p>
</div>
...
<table class="report-table">
	...
	<tbody>
		...
		<tr>
			...
			<td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{$data->expense_total_amount}}</td>
		</tr>
		@endforeach
		<tr>
			<td colspan="4" class="text-left"><b>Total</b></td>
			<td><b><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{ $total_expense }}</b></td>
		</tr>
	</tbody>
</table>
