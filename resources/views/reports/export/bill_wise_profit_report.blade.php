...
<hr>
<p class="text-right"><b>{{trans('lang.report_bill_wise_profit')}}</b></p>
<div class="detail-table">
	<span><b>Date : </b> {{date('d M Y', strtotime($start_date))}} - {{date('d M Y', strtotime($end_date))}} </span>
	<hr>
	<?php /*/ ?><span><b>Profit Amount : </b> {{$profit_amount}} </p><?php /*/ ?>
</div>
...
<table class="report-table">
	...
	<tbody>
		...
		<tr>
			...
			<td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{$data->amount}}</td>
			...
			<td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{$data->profit}}</td>
		</tr>
		@endforeach
		<?php /*/ ?>
		<tr>
			<td colspan="6" class="text-left"><b>Total</b></td>
			<td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{$profit_amount}}</td>
		</tr>
		<?php /*/ ?>
	</tbody>
</table>
