...
<hr>
<p class="text-right"><b>{{trans('lang.report_party_wise_outstanding')}}</b></p>
<div class="detail-table">
	<span><b>Date : </b> {{date('d M Y')}} </span>
	<!--<hr>-->
	<!--<span><b>To Pay : </b>  <b>To Collect : </b>  </p>-->
</div>
...
<table class="report-table">
	...
	<tbody>
		...
		<tr>
			<td>{{$data->name}}</td>
			<td>{{$data->total_no_transactions}}</td>
			<td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{$data->balance}} </td>
