...
<script type="text/javascript">
  ...
  var table = $('.dataTable').DataTable({
       ...
       serverSide: true,
       pageLength:20,
       ajax: "{{ route('reports.show') }}?report_type=stock-summary-report&start_date=&end_date=",
       columns: [
           ...
           {data: 'purchase_price', name: 'purchase_price', orderable: false, searchable: true, class: "text-right"},
           {data: 'price', name: 'price', orderable: false, searchable: true, class: "text-right"},
           {data: 'stock', name: 'stock', orderable: false, searchable: true, class: "text-right"},
           {data: 'stock_value', name: 'stock_value', orderable: false, searchable: true, class: "text-right"},
    ...
    function cb(start, end) {
        ...
        table.ajax.url("{{route('reports.show')}}?report_type=stock-summary-report&start_date="+start_date+"&end_date="+end_date).load(function(result) {});
    }
    ...
    $(document).on("click","#report",function() {
        ...
        window.open("{{route('reports.show')}}?type="+type+"&report_type=stock-summary-report&start_date="+start_date+"&end_date="+end_date,'_blank');
