    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Edit Stock Take</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>Edit Stock Take</a>
        </li>
      </ul>
    </div>
    
    <div class="card-body">
      {!! Form::model($stock_take, ['route' => ['stockTake.update', $stock_take->id], 'method' => 'patch', 'class' => 'stock-take-form']) !!}
      <div class="row">
