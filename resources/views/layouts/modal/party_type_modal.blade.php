  <!--Department-->
  <div class="modal fade" id="partyTypeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel">Create Party Type</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
        
        {!! Form::open(['route' => 'partyTypes.store', 'class' => 'party-type-form']) !!}
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary party-type-submit">Save changes</button>
        </div>
