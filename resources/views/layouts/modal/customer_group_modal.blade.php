  <!--Party Stream-->
  <div class="modal fade" id="customerGroupModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel">Create Party Group</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
        
        {!! Form::open(['route' => 'CustomerGroups.store', 'class' => 'customer-group-form']) !!}
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary customer-group-submit">Save changes</button>
        </div>
