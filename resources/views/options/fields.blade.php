  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="form-group">
        {!! Form::label('name', trans("lang.option_name"), ['class' => 'control-label text-right required']) !!}
      ...
      <!-- Price Field -->
      <div class="form-group">
        {!! Form::label('price', trans("lang.option_price"), ['class' => ' control-label text-right required']) !!}
    ...
    <!-- Product Id Field -->
      <div class="form-group">
        {!! Form::label('product_id', trans("lang.option_product_id"),['class' => ' control-label text-right required']) !!}
    ...
    <!-- Option Group Id Field -->
      <div class="form-group">
        {!! Form::label('option_group_id', trans("lang.option_option_group_id"),['class' => ' control-label text-right required']) !!}
    ...
    <div class="col-md-4">
      <!-- Description Field -->
      <div class="form-group ">
        {!! Form::label('description', trans("lang.option_description"), ['class' => ' control-label text-right']) !!}
    ...
    <div class="col-md-4">
      <!-- Image Field -->
      <div class="form-group">
        {!! Form::label('image', trans("lang.option_image"), ['class' => ' control-label text-right']) !!}
