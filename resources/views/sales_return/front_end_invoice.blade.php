      ...
      <tr>
         <td>
            <div class="float-right top-action-btn">
               <a href="{{url(base64_encode($sales_return->id).'/SalesReturn/DownloadPDF')}}"><button style="background: #881798;border: 1px solid #881798;" class="btn btn-primary btn-sm thermal_prints">
                 Download PDF
               </button></a>
            </div>
         </td>
      ...
      <div class="invoice_page_original" style="font-size:12px;background-color:#f4f4f533;">
         <div class="invoice_page1">
            <table style="width: auto; background-color:#f4f4f533;">
               <tr>
                  <td style="border: 0px solid #000; padding: 3px;"><b>Sales Return</b></td>
               </tr>
            </table>
            ...
            <table style="width: 100%; line-height:15px;" class="pdf_div1" cellpadding="15">
               <tr>
                  ...
                  <td width="33%">
                     <b>Date : </b> 
                     {{$sales_return->date->format('d M Y')}}
                  </td>
                  <td width="33%">
                     <b>Valid Date : </b> 
                     {{$sales_return->valid_date->format('d M Y')}}
                  </td>
               </tr>
            </table>
            <div class="pdf_whole" style="padding:10px;background-color:#f4f4f533;">
               ...
               <table style="width: 100%; line-height:15px;">
                  <tr>
                     <td width="33.33333%">  
                        <p><b>Bill To :</b></p>
                        <p><b>{{$sales_return->market->name}}</b></p>
                        <p>
                        <b>Address : </b> 
               ...
               <table class="table table-bordered view-table-custom-product-item" style="width: 100%; border-collapse: collapse;">
                  <tbody>      
                   ...
                   <tr>
                     ...
                     <td class="text-right">
                      {!! $currency !!} {{number_format($sales_return->sub_total,2,'.','')}}
                     </td>
                   </tr>
                   ...
                   @if($sales_return->tax_total > 0)
                     <tr>
                       ...
                       <td class="text-right">
                        {!! $currency !!} {{number_format($sales_return->tax_total,2,'.','')}}
                       </td>
                     </tr>
                   @endif
                   ...
                   @if($sales_return->discount_total > 0)
                     <tr>
                       ...
                       <td class="text-right">
                        {!! $currency !!} {{number_format($sales_return->discount_total,2,'.','')}}
                       </td>
                     </tr>
                   @endif
                   ...
                   @if($sales_return->additional_charge > 0)
                     <tr>
                       ...
                       <td class="text-right">
                        {!! $currency !!} {{number_format($sales_return->additional_charge,2,'.','')}}
                       </td>
                     </tr>
                   @endif
                   ...
                   @if($sales_return->delivery_charge > 0)
                     <tr>
                       ...
                       <td class="text-right">
                        {!! $currency !!} {{number_format($sales_return->delivery_charge,2,'.','')}}
                       </td>
                     </tr>
                   @endif
                   ...
                   <tr>
                     ...
                     <td class="text-right">
                       <b>{!! $currency !!} {{number_format($sales_return->total,2,'.','')}}</b>
                     </td>
                   </tr>
                   ...
                   @if($sales_return->amount_due > 0)
                     <tr>
                       ...
                       <td class="text-right">
                         <b>{!! $currency !!} {{number_format($sales_return->amount_due,2,'.','')}}</b>
                       </td>
                     </tr>
                   @endif
                  ...
                  <tr>
                     <td width="50%">
                        ...
                        <p>
                           ...
                           {!!$sales_return->terms_and_conditions!!}
                        </p>
                     </td>
