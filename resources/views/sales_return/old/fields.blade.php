  ...
  <div class="container custom-from-css">
    <div class="row" style="margin-top:20px;">
      ...
      <div class="col-md-8 mt-15" data-toggle="tooltip" title="{{trans('lang.shift_y')}}">
        ...
        {!! Form::select('sales_party', $users, $userSelected, ['class' => 'select2 form-control', 'onchange' => 'getPartyDetail(this)']) !!}
        <!-- <div class="form-text text-muted">{{ trans("lang.sales_return_party_help") }}</div> -->
        </div>
      ...
      <div class="col-md-4 mt-15">
          ...
          <div class="form-group row">
            {!! Form::label('sales_code', trans("lang.sales_return_no"), ['class' => 'label-left col-md-4 control-label text-left']) !!}
            {!! Form::text('sales_code', isset($sales_return_no) ? $sales_return_no : '' ,  ['class' => 'col-md-8 form-control']) !!}
            <!-- <div class="form-text text-muted">{{ trans("lang.sales_return_no_help") }}</div> -->
          </div>

          <div class="form-group row">
            {!! Form::label('sales_date', trans("lang.sales_return_date"), ['class' => 'label-left col-md-4 control-label text-left']) !!}
            {!! Form::text('sales_date', date('Y-m-d'),  ['class' => 'col-md-8 form-control datepicker', 'readonly' => 'readonly']) !!}
            <!-- <div class="form-text text-muted">{{ trans("lang.sales_return_date_help") }}</div> -->
          </div>

          <div class="form-group row">
            {!! Form::label('valid_date', trans("lang.sales_return_valid_date"), ['class' => 'label-left col-md-4 control-label text-left']) !!}
      ...
      <div class="col-md-4">
        ...
        {!! Form::label('description', trans("lang.sales_return_description"), ['class' => 'control-label text-right']) !!}
        {!! Form::textarea('description', null, ['class' => 'form-control','placeholder'=>
               trans("lang.po_description_placeholder")  ]) !!}
        <!-- <div class="form-text text-muted">{{ trans("lang.sales_return_description_help") }}</div> -->

        </div>
        <div class="col-md-4">

        {!! Form::label('terms_and_conditions', trans("lang.po_terms_and_conditions"), ['class' => 'control-label text-right']) !!}
        {!! Form::textarea('terms_and_conditions', setting('app_invoice_terms_and_conditions'), ['class' => 'form-control','placeholder'=>
          ...
          <table class="table table-bordered">
            <tr>
              ...
              <td class="text-right">
                ...
                <!-- <div class="form-text text-muted">{{ trans("lang.sales_return_taxable_amount") }}</div> -->
            ...
            <tr>
              ...
              <td class="text-right">
                ...
                <!-- <div class="form-text text-muted">{{ trans("lang.sales_return_sgst_amount") }}</div> -->
              </td>
            </tr>
            ...
            <tr>
              ...
              <td class="text-right">
                ...
                <!-- <div class="form-text text-muted">{{ trans("lang.sales_return_cgst_amount") }}</div> -->
              </td>
            </tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="text-right">
                    ...
                    <!-- <div class="form-text text-muted">{{ trans("lang.sales_return_additional_charge_help") }}</div> -->
                </td>
              </tr>
              <tr>
                <td class="text-right">
                ...
                <td class="text-right">
                    ...
                    <!-- <div class="form-text text-muted">{{ trans("lang.sales_return_additional_charge_detail_help") }}</div> -->
                </td>
              </tr>
            ...
            <tr>
              ...
              <td class="text-right">
                  <div class="input-group">
                    <span class="input-group-addon">₹</span>
                      {!! Form::text('total_sales_amount', null,  ['class' => 'form-control', 'id' => 'total_purchase_amount']) !!}
                  </div>  
                  <!-- <div class="form-text text-muted">{{ trans("lang.sales_return_total_amount_help") }}</div> -->
              </td>
            </tr>
            <tr>
              ...
              <td class="text-right">
                  ...
                  <!-- <div class="form-text text-muted">{{ trans("lang.sales_return_cash_paid_help") }}</div> -->
              </td>
            </tr>
            <tr>
              ...
              <td class="text-right">
                  ...
                  <!-- <div class="form-text text-muted">{{ trans("lang.sales_return_balance_amount_help") }}</div> -->
              </td>
            </tr>
          </table>
      </div>
