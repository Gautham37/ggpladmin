    ...
    <div class="row" style="margin-top:20px;">
      ...
      <div class="col-md-4 mt-15">
          ...
          <div class="form-group row">
            ...
            {!! Form::text('sales_code', $sales_return->sales_code,  ['class' => 'col-md-8 form-control']) !!}
          ...
          <div class="form-group row">
            ...
            {!! Form::text('sales_date', $sales_return->sales_date,  ['class' => 'col-md-8 form-control datepicker', 'readonly' => 'readonly']) !!}
          ...
          <div class="form-group row">
            ...
            {!! Form::text('valid_date', $sales_return->sales_valid_date,  ['class' => 'col-md-8 form-control datepicker', 'readonly' => 'readonly']) !!}
