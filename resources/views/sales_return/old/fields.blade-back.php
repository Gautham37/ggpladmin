    ...
    <div class="row">
      ...
      <div class="col-md-4 row">
          ...
          <div class="col-md-6">
            ...
            {!! Form::text('sales_code', isset($sales_return_no) ? $sales_return_no : '' ,  ['class' => 'form-control']) !!}
          ...
          <div class="col-md-6">
            ...
            {!! Form::text('sales_date', date('Y-m-d'),  ['class' => 'form-control datepicker', 'readonly' => 'readonly']) !!}
