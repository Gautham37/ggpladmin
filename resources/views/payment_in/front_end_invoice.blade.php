      ...
      <tr>
         <td>
            <div class="float-right top-action-btn">
               <a href="{{url(base64_encode($payment_in->id).'/PaymentIn/DownloadPDF')}}"><button style="background: #881798;border: 1px solid #881798;" class="btn btn-primary btn-sm thermal_prints">
                 Download PDF
               </button></a>
            </div>
         </td>
