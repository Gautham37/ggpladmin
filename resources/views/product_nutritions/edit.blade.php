  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link" href="{!! route('productNutritions.index') !!}"><i class="fa fa-list mr-2"></i>Product Nutritions List</a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-edit mr-2"></i>Edit Product Nutrition</a>
        </li>
        @endcan
      </ul>
    </div>
    ...
    <div class="card-body">
      {!! Form::model($product_nutrition, ['route' => ['productNutritions.update', $product_nutrition->id], 'method' => 'patch']) !!}
      <div class="row">
        @include('product_nutritions.fields')
      </div>
      {!! Form::close() !!}
      <div class="clearfix"></div>
    </div>
