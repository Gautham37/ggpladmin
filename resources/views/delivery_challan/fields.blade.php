...
@endif
  ...
  <style type="text/css">
    ...
    .form-control {
      font-size: 12px !imdcrtant;
      padding: 2px 5px !imdcrtant;
      background: #eceaef;
    }
  ...
  <div class="container custom-from-css">
    <div class="row " style="margin-top:20px;">
      ...
      <div class="col-md-8 mt-15" data-toggle="tooltip" title="{{trans('lang.shift_y')}}">
        ...
        {!! Form::label('delivery_party', trans("lang.dc_party"),['class' => 'control-label text-right']) !!}
        {!! Form::select('delivery_party', $markets, $marketSelected, ['class' => 'select2 form-control', 'onchange' => 'getPartyDetail(this)']) !!}
      ...
      <div class="col-md-4 mt-15">
          ...
          <div class="form-group row">
            {!! Form::label('delivery_code', trans("lang.dc_no"), ['class' => 'label-left col-md-4 control-label text-left']) !!}
            {!! Form::text('delivery_code', isset($delivery_challan_no) ? $delivery_challan_no : '' ,  ['class' => 'col-md-8 form-control']) !!}
            <!-- <div class="form-text text-muted">{{ trans("lang.dc_no_help") }}</div> -->
          </div>

          <div class="form-group row">
            {!! Form::label('delivery_date', trans("lang.dc_date"), ['class' => 'label-left col-md-4 control-label text-left']) !!}
            {!! Form::text('delivery_date', date('Y-m-d'),  ['class' => 'col-md-8 form-control datepicker', 'readonly' => 'readonly']) !!}
            <!-- <div class="form-text text-muted">{{ trans("lang.dc_date_help") }}</div> -->
          </div>

          <div class="form-group row">
            {!! Form::label('valid_date', trans("lang.dc_valid_date"), ['class' => 'label-left col-md-4 control-label text-left']) !!}
      ...
      <div class="col-md-12">
          <table id="deliveryItems" class="table table-bordered tbl-product-details">
            <thead>
              <tr>
                <th>NO</th>
                <th>ITEMS</th>
      ...
      <div class="col-md-4">
        ...
        {!! Form::label('description', trans("lang.dc_description"), ['class' => 'control-label text-right']) !!}
        {!! Form::textarea('description', null, ['class' => 'form-control','placeholder'=>
               trans("lang.dc_description_placeholder")  ]) !!}
        <!-- <div class="form-text text-muted">{{ trans("lang.dc_description_help") }}</div> -->
        </div>
        <div class="col-md-4">

        {!! Form::label('terms_and_conditions', trans("lang.dc_terms_and_conditions"), ['class' => 'control-label text-right']) !!}
        {!! Form::textarea('terms_and_conditions', null, ['class' => 'form-control','placeholder'=>
               trans("lang.dc_terms_and_conditions_placeholder")  ]) !!}
        <!-- <div class="form-text text-muted">{{ trans("lang.dc_terms_and_conditions_help") }}</div> -->
          ...
          <table class="table table-bordered">
            <tr>
              ...
              <td class="text-right">
                ...
                <!-- <div class="form-text text-muted">{{ trans("lang.dc_taxable_amount") }}</div> -->
            ...
            <tr>
              ...
              <td class="text-right">
                ...
                <!-- <div class="form-text text-muted">{{ trans("lang.dc_sgst_amount") }}</div> -->
              </td>
            </tr>
            ...
            <tr>
              ...
              <td class="text-right">
                ...
                <!-- <div class="form-text text-muted">{{ trans("lang.dc_cgst_amount") }}</div> -->
              </td>
            </tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="text-right">
                    <div class="input-group">
                      <span class="input-group-addon">₹</span>
                      {!! Form::text('additional_charges', null,  ['class' => 'form-control additional_charges', 'id' => 'additional_charges']) !!}
                    </div>
                    <!-- <div class="form-text text-muted">{{ trans("lang.dc_additional_charge_help") }}</div> -->
                </td>
              </tr>
              <tr>
                <td class="text-right">
                ...
                <td class="text-right">
                    <div class="input-group">
                       {!! Form::text('additional_charge_detail', null,  ['class' => 'form-control additional_charge_detail']) !!}
                    </div>
                    <!-- <div class="form-text text-muted">{{ trans("lang.dc_additional_charge_detail_help") }}</div> -->
                </td>
              </tr>
            ...
            <tr>
              ...
              <td class="text-right">
                  <div class="input-group">
                    <span class="input-group-addon">₹</span>
                      {!! Form::text('total_delivery_amount', null,  ['class' => 'form-control', 'id' => 'total_purchase_amount']) !!}
                  </div>  
                  <!-- <div class="form-text text-muted">{{ trans("lang.dc_total_amount_help") }}</div> -->
              </td>
            </tr>
            <?php /* ?>
            <tr>
              ...
              <td class="text-right">
                  ...
                  <div class="form-text text-muted">{{ trans("lang.dc_cash_paid_help") }}</div>
              </td>
            </tr>
            <tr>
              ...
              <td class="text-right">
                  ...
                  <div class="form-text text-muted">{{ trans("lang.dc_balance_amount_help") }}</div>
              </td>
            </tr>
            <?php /*/ ?>
          </table>
