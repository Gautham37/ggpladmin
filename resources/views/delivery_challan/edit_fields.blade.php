    ...
    <div class="row" style="margin-top:20px;">
      ...
      <div class="col-md-4 mt-15">
          ...
          <div class="form-group row">
            ...
            {!! Form::text('delivery_code', $delivery_challan->delivery_code,  ['class' => 'col-md-8 form-control']) !!}
          ...
          <div class="form-group row">
            ...
            {!! Form::text('delivery_date', $delivery_challan->delivery_date,  ['class' => 'col-md-8 form-control datepicker', 'readonly' => 'readonly']) !!}
          ...
          <div class="form-group row">
            ...
            {!! Form::text('valid_date', $delivery_challan->delivery_valid_date,  ['class' => 'col-md-8 form-control datepicker', 'readonly' => 'readonly']) !!}
