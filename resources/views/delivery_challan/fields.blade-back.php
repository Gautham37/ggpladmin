    ...
    <div class="row">
      ...
      <div class="col-md-4 row">
          ...
          <div class="col-md-6">
            ...
            {!! Form::text('delivery_code', isset($delivery_challan_no) ? $delivery_challan_no : '' ,  ['class' => 'form-control']) !!}
          ...
          <div class="col-md-6">
            ...
            {!! Form::text('delivery_date', date('Y-m-d'),  ['class' => 'form-control datepicker', 'readonly' => 'readonly']) !!}
          ...
          <div class="col-md-6">
            ...
            {!! Form::text('valid_date', date('Y-m-d', time() + (86400 * 15)),  ['class' => 'form-control datepicker', 'readonly' => 'readonly']) !!}
