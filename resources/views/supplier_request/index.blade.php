    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">{{trans('lang.supplier_request_table')}}</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.supplier_request_table')}}</a>
        </li>
        @can('supplierRequest.create')
        <li class="nav-item">
          <a class="nav-link" id="new-invoice" href="{!! route('supplierRequest.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.supplier_request_create')}}</a>
        </li>
        @endcan
    ...
    <div class="card-body">
      ...
      @include('supplier_request.table')
      <div class="clearfix"></div>
    </div>
  </div>
</div>
