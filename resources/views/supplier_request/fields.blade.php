    ...
    <div class="row " style="margin-top:20px;">
      ...
      <div class="col-md-8 mt-15" data-toggle="tooltip" title="{{trans('lang.shift_y')}}">
        ...
        <div class="col-md-12" style="margin-top:-35px;">
            {!! Form::label('sr_party', trans("lang.supplier_request_party"),['class' => 'label-left control-label text-left']) !!}
            {!! Form::select('sr_party', $users, $userSelected, ['class' => 'width-100 select2 form-control', 'onchange' => 'getPartyDetail(this)']) !!}
            <!--<div class="form-text text-muted">{{ trans("lang.supplier_request_party_help") }}</div>-->
        </div>
      ...
      <div class="col-md-4 mt-15">
          ...
          <div class="form-group row">
            ...
            {!! Form::text('sr_code', isset($supplier_request_no) ? $supplier_request_no : '' ,  ['class' => 'col-md-7 form-control']) !!}
          ...
          <div class="form-group row">
            ...
            {!! Form::text('sr_date', date('Y-m-d'),  ['class' => 'col-md-7 form-control datepicker', 'readonly' => 'readonly']) !!}
          ...
          <div class="form-group row">
            ...
            {!! Form::text('sr_valid_date', date('Y-m-d', time() + (86400 * 15)),  ['class' => 'col-md-7 form-control datepicker', 'readonly' => 'readonly']) !!}
      ...
      <div class="col-md-6">
        ...
        {!! Form::label('description', trans("lang.supplier_request_description"), ['class' => 'control-label text-left']) !!}
        {!! Form::textarea('description', null, ['class' => 'form-control','placeholder'=>
               trans("lang.po_description_placeholder")  ]) !!}
        <!--<div class="form-text text-muted">{{ trans("lang.supplier_request_description_help") }}</div>-->
          ...
          <table class="table table-bordered">
            <tr>
              ...
              <td class="text-right">
                ...
                <!--<div class="form-text text-muted">{{ trans("lang.supplier_request_taxable_amount") }}</div>-->
