  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>{{trans('lang.complaint_comments')}}</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      {!! Form::model($complaints, ['route' => ['complaints.viewComments', $complaints->id], 'method' => 'post']) !!}
      <div class="row">
        @include('complaints.comments_fields')
      </div>
      {!! Form::close() !!}
      <div class="clearfix"></div>
    </div>
