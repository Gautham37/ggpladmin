  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" id="new-invoice" href="{!! route('purchaseInvoice.create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.purchase_invoice_create')}}</a>
        </li>
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>{{trans('lang.purchase_invoice_edit')}}</a>
        </li>
      </ul>
    </div>
    
    <div class="card-body">
      {!! Form::model($purchase_invoice, ['route' => ['purchaseInvoice.update', $purchase_invoice->id], 'method' => 'patch', 'id' => 'purchaseInvoiceForm']) !!}
      <div class="row">
...
function addItem() {
  ...
  $("document").ready(function(){
      $.ajax({
          url: "{{ url('/purchaseInvoice/loadPurchaseDetailItems') }}",
          type: 'post',
          dataType: 'JSON',
          data: {
            '_token' : "{{ csrf_token() }}",
