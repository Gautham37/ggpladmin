  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-8" data-toggle="tooltip" title="{{trans('lang.shift_y')}}">
        ...
        <div class="purchase_party_details"></div>
      ...
      <div class="col-md-4 row">
          ...
          <div class="col-md-6">
            ...
            {!! Form::text('purchase_code', $purchase_invoice_no,  ['class' => 'form-control']) !!}
          ...
          <div class="col-md-6">
            ...
            {!! Form::text('purchase_date', $purchase_invoice->sr_date,  ['class' => 'form-control datepicker', 'readonly' => 'readonly']) !!}
          ...
          <div class="col-md-6">
            ...
            {!! Form::text('valid_date', $purchase_invoice->sr_valid_date,  ['class' => 'form-control datepicker', 'readonly' => 'readonly']) !!}
            ...
            <tfoot>
              ...
              <th>
                <div class="input-group">
                  ...
                  {!! Form::text('total_discount', '',  ['class' => 'form-control total_discount', 'readonly' => 'readonly']) !!}
                </div>
              </th>
              <th>
                <div class="input-group">
                  <span class="input-group-addon">₹</span>
                  {!! Form::text('total_tax', '',  ['class' => 'form-control total_tax', 'readonly' => 'readonly']) !!}
                </div>
              </th>
              <th>
                <div class="input-group">
                  <span class="input-group-addon">₹</span>
                  {!! Form::text('total_amount', '',  ['class' => 'form-control total_amount', 'readonly' => 'readonly']) !!}
                </div>
              </th>
              <th></th>
            </tfoot>
      ...
      <div class="col-md-6">
        ...
        {!! Form::textarea('description', $purchase_invoice->sr_notes, ['class' => 'form-control','placeholder'=>
        ...
        {!! Form::textarea('terms_and_conditions', '', ['class' => 'form-control','placeholder'=>
          ...
          <table class="table table-bordered">
            <tr>
              ...
              <td class="text-right">
                ...
                <div class="input-group">
                  <span class="input-group-addon">₹</span>
                  {!! Form::text('taxable_amount', $purchase_invoice->sr_taxable_amount,  ['class' => 'form-control taxable_amount']) !!}
                </div>
            ...
            <tr>
              ...
              <td class="text-right">
                <div class="input-group">
                  <span class="input-group-addon">₹</span>
                  {!! Form::text('sgst_amount', '',  ['class' => 'form-control sgst_amount']) !!}
                </div>
            ...
            <tr>
              ...
              <td class="text-right">
                <div class="input-group">
                  <span class="input-group-addon">₹</span>
                  {!! Form::text('cgst_amount', '',  ['class' => 'form-control cgst_amount']) !!}
                </div>
            ...
            <tr>
              <td class="text-left">
                  Additional Charges
                  {!! Form::text('additional_charge_detail', '',  ['class' => 'form-control additional_charge_detail']) !!}
                  <div class="form-text text-muted">{{ trans("lang.po_additional_charge_detail_help") }}</div>
              </td>
              <td class="text-right">
                  <div class="input-group">
                    <span class="input-group-addon">₹</span>
                    {!! Form::text('additional_charges', '',  ['class' => 'form-control additional_charges', 'id' => 'additional_charges']) !!}
                  </div>
            ...
            <tr>
              ...
              <td class="text-right">
                  <div class="input-group">
                    <span class="input-group-addon">₹</span>
                      {!! Form::text('total_purchase_amount', '',  ['class' => 'form-control', 'id' => 'total_purchase_amount']) !!}
                  </div>  
            ...
            <tr>
              ...
              <td class="text-right">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon">₹</span>
                    {!! Form::text('cash_paid', '',  ['class' => 'form-control cash_paid', 'id' => 'cash_paid']) !!}
                  </div>
            ...
            <tr>
              ...
              <td class="text-right">
                  <div class="input-group">
                    <span class="input-group-addon">₹</span>
                    {!! Form::text('balance_amount', '',  ['class' => 'form-control balance_amount', 'id' => 'balance_amount']) !!}
                  </div>
