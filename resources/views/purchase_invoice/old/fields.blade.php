    ...
    <div class="row" style="margin-top:20px;">
      ...
      <div class="col-md-8 mt-15" data-toggle="tooltip" title="{{trans('lang.shift_y')}}">
        <div class="row"> 
          ...
          <div class="col-md-12" style="margin-top:-35px;">
            {!! Form::label('purchase_party', trans("lang.purchase_invoice_party"),['class' => 'label-left control-label text-left']) !!}
      ...
      <div class="col-md-4 mt-15">
          ...
          <div class="form-group row">
            {!! Form::label('purchase_code', trans("lang.purchase_invoice_po_no"), ['class' => 'label-left col-md-4 control-label text-left']) !!}
            {!! Form::text('purchase_code', isset($purchase_invoice_no) ? $purchase_invoice_no : '' ,  ['class' => 'col-md-8 form-control']) !!}
            <!-- <div class="form-text text-muted">{{ trans("lang.purchase_invoice_po_no_help") }}</div> -->
          </div>

          <div class="form-group row">
            {!! Form::label('purchase_date', trans("lang.purchase_invoice_po_date"), ['class' => 'label-left col-md-4 control-label text-left']) !!}
