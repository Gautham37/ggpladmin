      ...
      <div id="table" style="display: flex;">
         ...
         <table style="width:50%;">
            ...
            <tr class="service">
               ...
               <td class="tableitem"><p class="itemtext">{{$quote->market->name}}</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Bill No</p></td>
               <td class="tableitem"><p class="itemtext">{{$quote->code}}</p></td>
            </tr>
         </table>
         ...
         <table style="width:50%;">
            <tr class="service">
               ...
               <td class="tableitem"><p class="itemtext">{{$quote->createdby->name}}</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Date</p></td>
               <td class="tableitem"><p class="itemtext">{{$quote->date->format('d/m/Y')}}</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Time</p></td>
               <td class="tableitem"><p class="itemtext">{{$quote->created_at->format('H:i:s')}}</p></td>
            </tr>
         </table>
               ...
               <div id="table">
                  <table>
                     ...
                     <tr class="tabletitle">
                        ...
                        <td class="payment text-right"><b>{{number_format($quote->sub_total,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right">Discount</td>
                        <td class="payment text-right"><b>{{number_format($quote->discount_total,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right">GST</td>
                        <td class="payment text-right"><b>{{number_format($quote->tax_total,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right">Delivery Charge</td>
                        <td class="payment text-right"><b>{{number_format($quote->delivery_charge,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right"><b>Net Amount</b></td>
                        <td class="payment text-right"><b>{{number_format($quote->total,2,'.','')}}</b></td>
                     </tr>
