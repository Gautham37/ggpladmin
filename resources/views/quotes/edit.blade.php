  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        @can('quotes.create')
        <li class="nav-item">
          <a class="nav-link" href="{!! route('quotes.create') !!}"><i class="fa fa-plus mr-2"></i>Create Quote</a>
        </li>
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>Edit Quote</a>
        </li>
      </ul>
    </div>
    
    <div class="card-body">
      {!! Form::model($quote, ['route' => ['quotes.update', $quote->id], 'method' => 'patch', 'class' => 'quotes-form']) !!}
      <div class="row">
