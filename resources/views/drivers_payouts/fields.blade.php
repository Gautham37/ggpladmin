  ...
  <div class="row">
    ...
    <div class="col-md-5">
      ...
      <div class="form-group ">
        {!! Form::label('user_id', trans("lang.drivers_payout_user_id"),['class' => ' control-label text-left']) !!}
      ...
      <!-- Method Field -->
      <div class="form-group ">
        {!! Form::label('method', trans("lang.drivers_payout_method"),['class' => ' control-label text-left']) !!}
      ...
      <!-- Amount Field -->
      <div class="form-group ">
        {!! Form::label('amount', trans("lang.drivers_payout_amount"), ['class' => ' control-label text-left']) !!}
    ...
    <div class="col-md-5">
      <!-- Note Field -->
      <div class="form-group  ">
        {!! Form::label('note', trans("lang.drivers_payout_note"), ['class' => ' control-label text-left']) !!}
