        ...
        <script type="text/javascript">
            ...
            var dz_var1598988452806641953ble = $(".dropzone.image").dropzone({
                    ...
                    removedfile: function (file) {
                        dzRemoveFile(
                            file, var1598988452806641953ble, '{!! url("farmerSlides/remove-media") !!}',
...
<div class="form-group col-12 text-right">
    <button type="submit" class="btn btn-{{setting('theme_color')}}"><i class="fa fa-save"></i> Save Farmer Slide</button>
    <a href="{!! route('farmerSlides.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> Cancel </a>
</div>
