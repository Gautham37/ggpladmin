    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{!! route('purchaseOrder.index') !!}">Purchase Orders</a></li>
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>Create Purchase Order</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
        {!! Form::open(['route' => 'purchaseOrder.store','class' => 'purchase-order-form']) !!}
            <div class="row">
