    ...
    <div class="row" style="margin-top:20px;">
      ...
      @include('layouts.invoice_header')
        ...
        <div class="col-md-4 mt-4">
          ...
          <div class="form-group row">
            {!! Form::label('code', 'Purchase Order No', ['class' => 'label-left col-md-4 control-label text-left']) !!}
          ...
          <div class="form-group row">
            ...
            {!! Form::text('date', isset($purchase_order) ? $purchase_order->date->format('d-m-Y') : date('d-m-Y'),  ['class' => 'col-md-8 form-control datepicker', 'readonly' => 'readonly']) !!}
          </div>

          <div class="form-group row">
            {!! Form::label('valid_date', 'Valid Date', ['class' => 'label-left col-md-4 control-label text-left']) !!}
            {!! Form::text('valid_date', isset($purchase_order) ? $purchase_order->valid_date->format('d-m-Y') : date('d-m-Y', time() + (86400 * 15)),  ['class' => 'col-md-8 form-control datepicker', 'readonly' => 'readonly']) !!}
          </div>
      ...
      <div class="col-md-12">
          <table id="salesItems" class="table table-bordered tbl-product-details">
            ...
            <tbody class="purchase-order-items"></tbody>
            <!-- <tfoot>
    ...
    <div class="row">  
      ...
      <div class="col-md-7">
        ...
        <div class="col-md-12"> 
          ...
          {!! Form::textarea('terms_and_conditions', isset($purchase_order) ? null : setting('app_invoice_terms_and_conditions'), ['class' => 'form-control']) !!}
        </div>
      </div>
...
<div class="form-group col-12 text-right">
  <button type="submit" class="btn btn-{{setting('theme_color')}} purchase-order-form-submit" ><i class="fa fa-save"></i> Save Purchase Order</button>
  <a href="{!! route('purchaseOrder.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> Cancel </a>
</div>
...
<script>
  ...
  function cartarrayToTable() {
    ...
    $(".purchase-order-items").html(in_html);
  ...
  @if(isset($purchase_order))
    ...
    $(document).ready(function() {
      ...
      var url   = '{!!route('purchaseOrder.show',$purchase_order->id)!!}';
      var token = "{{ csrf_token() }}";
      $.ajax({
          type: 'GET',
          data: {
