    ...
    <div class="row" style="margin-top:20px;">
      ...
      <div class="col-md-4 mt-15">
          ...
          <div class="form-group row">
            ...
            {!! Form::text('purchase_code', $purchase_order->purchase_code,  ['class' => 'col-md-8 form-control']) !!}
          ...
          <div class="form-group row">
            ...
            {!! Form::text('purchase_date', $purchase_order->purchase_date,  ['class' => 'col-md-8 form-control datepicker', 'readonly' => 'readonly']) !!}
          ...
          <div class="form-group row">
            ...
            {!! Form::text('valid_date', $purchase_order->purchase_valid_date,  ['class' => 'col-md-8 form-control datepicker', 'readonly' => 'readonly']) !!}
