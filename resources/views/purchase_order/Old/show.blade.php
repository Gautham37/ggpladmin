...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">{{trans('lang.purchase_order_plural')}}<small class="ml-3 mr-3">|</small><small>{{trans('lang.purchase_order_desc')}}</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{url('/dashboard')}}"><i class="fa fa-dashboard"></i> {{trans('lang.dashboard')}}</a></li>
          <li class="breadcrumb-item"><a href="{!! route('purchaseOrder.index') !!}">{{trans('lang.purchase_order_plural')}}</a>
          </li>
          <li class="breadcrumb-item active">{{trans('lang.purchase_order')}}</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header d-print-none">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link" href="{!! route('purchaseOrder.index') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang.purchase_order_table')}}</a>
        </li>
        
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.purchase_order')}}</a>
        </li>
        ...
        <div class="dropdown float-right top-action-btn">
          ...
          <ul class="dropdown-menu">
            <li><a target="_blank" id="download-invoice" href='{{url("/purchaseOrder/downloadPurchaseOrder/$purchase_order->id/1")}}'>Download Original</a></li>
          </ul>
        </div>
        ...
        <div class="dropdown float-right top-action-btn">
          ...
          <span class="caret"></span></button>
          <ul class="dropdown-menu">
            <li><a target="_blank" id="print-invoice" href='{{url("/purchaseOrder/printPurchaseOrder/$purchase_order->id/1")}}'>Print Original</a></li>
          </ul>
        </div>

        <div class="float-right top-action-btn">
            <button style="background: #c30052;border: 1px solid #c30052;" id="thermal-print-invoice" class="btn btn-primary btn-sm thermal_prints" href='{{url("/purchaseOrder/thermalprintPurchaseOrder/$purchase_order->id")}}'>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td width="20%" colspan="2">
                    <p style="margin-bottom:0px;"><b>{{trans('lang.purchase_order_po_no')}}</b></p>
                    <p>{{$purchase_order->purchase_code}}</p>  
                  </td>
                  <td width="20%" colspan="2">
                    <p style="margin-bottom:0px;"><b>{{trans('lang.purchase_order_po_date')}}</b></p>
                    <p>{{date('d-m-Y',strtotime($purchase_order->purchase_date))}}</p>
                  </td>
                </tr>
                <tr>
                  <td width="60%" colspan="6">
                      <b>{{$purchase_party->name}}</b>
                      <p>
                       <b>{{trans('lang.address')}} : </b> <br> {{$purchase_party->address_line_1}}, {{$purchase_party->address_line_2}}<br>
                  ...
                  <td width="40%" colspan="4">
                    ...
                    <p>{{date('d-m-Y',strtotime($purchase_order->purchase_valid_date))}}</p>  
                  </td>
                </tr>
          ...
          <table class="table table-bordered view-table-custom-product-item">
            <tbody>      
                ...
                <tr>
                  ...
                  <td>₹ {{$purchase_order->purchase_discount_amount}}</td>
                  <td>₹ {{$purchase_order->purchase_igst_amount}}</td>
                  <td>₹ {{($purchase_order->purchase_total_amount - $purchase_order->purchase_additional_charge)}}</td>  
                </tr>
            ...
            <tbody>
                <tr>
                  <td rowspan="5" width="50%">
                    ...
                    {!!$purchase_order->purchase_notes!!}

                    <p style="margin-bottom:5px;"><b>{{trans('lang.po_table_terms_and_conditions')}}</b></p>
                    {!!$purchase_order->purchase_terms_and_conditions!!}
                  </td>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    {{$purchase_order->purchase_sgst_amount}}
                  </td>
                </tr>
                <tr>
                  <td class="font-weight-600">
                  ...
                  <td class="text-right">
                    {{$purchase_order->purchase_cgst_amount}}
                  </td>
                </tr>
                <tr>
                  <td class="font-weight-600">
                    {{ trans('lang.po_additional_charge')}}<br>
                    {{$purchase_order->purchase_additional_charge_description}}
                  </td>
                  <td  class="text-right">
                    {{$purchase_order->purchase_additional_charge}}
                  </td>
                </tr>
                <tr>
                  <td class="font-weight-600">
                  ...
                  <td class="text-right">
                    {{$purchase_order->purchase_round_off}}
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="text-right">
                    {{$purchase_order->purchase_total_amount}}
                  </td>
                </tr>
                <?php /* ?>
                <tr>
                  ...
                  <td class="text-right">
                    {{$purchase_order->purchase_cash_paid}}
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td class="text-right">
                    {{$purchase_order->purchase_balance_amount}}
                  </td>
                </tr>
                <?php */ ?>
                <tr>
                  <td colspan="2">
                    ...
                    <img style="width: 25%; float: right;" src="https://www.docsketch.com/assets/vip-signatures/muhammad-ali-signature-6a40cd5a6c27559411db066f62d64886c42bbeb03b347237ffae98b0b15e0005.svg">
                  </td>
                </tr>
