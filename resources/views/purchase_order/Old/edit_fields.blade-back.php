  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        {!! Form::label('purchase_party', trans("lang.purchase_order_party"),['class' => 'control-label text-right']) !!}
      ...
      <div class="col-md-4 row">
          ...
          <div class="col-md-6">
            {!! Form::label('purchase_code', trans("lang.purchase_order_po_no"), ['class' => 'control-label text-right']) !!}
            {!! Form::text('purchase_code', $purchase_order->purchase_code,  ['class' => 'form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.purchase_order_po_no_help") }}</div>
          </div>

          <div class="col-md-6">
            {!! Form::label('purchase_date', trans("lang.purchase_order_po_date"), ['class' => 'control-label text-right']) !!}
            {!! Form::text('purchase_date', $purchase_order->purchase_date,  ['class' => 'form-control datepicker', 'readonly' => 'readonly']) !!}
          ...
          <div class="col-md-6">
            ...
            {!! Form::text('valid_date', $purchase_order->purchase_valid_date,  ['class' => 'form-control datepicker', 'readonly' => 'readonly']) !!}
            ...
            <tfoot>
              ...
              <th>
                <div class="input-group">
                  ...
                  {!! Form::text('total_discount', $purchase_order->purchase_discount_amount,  ['class' => 'form-control total_discount', 'readonly' => 'readonly']) !!}
                </div>
              </th>
              <th>
                <div class="input-group">
                  <span class="input-group-addon">₹</span>
                  {!! Form::text('total_tax', $purchase_order->purchase_igst_amount,  ['class' => 'form-control total_tax', 'readonly' => 'readonly']) !!}
                </div>
              </th>
              <th>
                <div class="input-group">
                  <span class="input-group-addon">₹</span>
                  {!! Form::text('total_amount', $purchase_order->purchase_total_amount,  ['class' => 'form-control total_amount', 'readonly' => 'readonly']) !!}
                </div>
              </th>
              <th></th>
            </tfoot>
      ...
      <div class="col-md-6">
        ...
        {!! Form::textarea('description', $purchase_order->purchase_notes, ['class' => 'form-control','placeholder'=>
        ...
        {!! Form::textarea('terms_and_conditions', $purchase_order->purchase_terms_and_conditions, ['class' => 'form-control','placeholder'=>
          ...
          <table class="table table-bordered">
            <tr>
              ...
              <td class="text-right">
                ...
                <div class="input-group">
                  <span class="input-group-addon">₹</span>
                  {!! Form::text('taxable_amount', $purchase_order->purchase_taxable_amount,  ['class' => 'form-control taxable_amount']) !!}
                </div>
            ...
            <tr>
              ...
              <td class="text-right">
                <div class="input-group">
                  <span class="input-group-addon">₹</span>
                  {!! Form::text('sgst_amount', $purchase_order->purchase_sgst_amount,  ['class' => 'form-control sgst_amount']) !!}
                </div>
            ...
            <tr>
              ...
              <td class="text-right">
                <div class="input-group">
                  <span class="input-group-addon">₹</span>
                  {!! Form::text('cgst_amount', $purchase_order->purchase_cgst_amount,  ['class' => 'form-control cgst_amount']) !!}
                </div>
            ...
            <tr>
              <td class="text-left">
                  Additional Charges
                  {!! Form::text('additional_charge_detail', $purchase_order->purchase_additional_charge_description,  ['class' => 'form-control additional_charge_detail']) !!}
                  <div class="form-text text-muted">{{ trans("lang.po_additional_charge_detail_help") }}</div>
              </td>
              <td class="text-right">
                  <div class="input-group">
                    <span class="input-group-addon">₹</span>
                    {!! Form::text('additional_charges', $purchase_order->purchase_additional_charge,  ['class' => 'form-control additional_charges', 'id' => 'additional_charges']) !!}
                  </div>
            ...
            <tr>
              ...
              <td class="text-right">
                  <div class="input-group">
                    <span class="input-group-addon">₹</span>
                      {!! Form::text('total_purchase_amount', $purchase_order->purchase_total_amount,  ['class' => 'form-control', 'id' => 'total_purchase_amount']) !!}
                  </div>  
            ...
            <!-- <tr>
              ...
              <td class="text-right">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon">₹</span>
                        {!! Form::text('cash_paid', $purchase_order->purchase_cash_paid,  ['class' => 'form-control cash_paid', 'id' => 'cash_paid']) !!}
                  </div>
            ...
            <tr>
              ...
              <td class="text-right">
                  <div class="input-group">
                    <span class="input-group-addon">₹</span>
                    {!! Form::text('balance_amount', $purchase_order->purchase_balance_amount,  ['class' => 'form-control balance_amount', 'id' => 'balance_amount']) !!}
                  </div>
...
<div class="form-group col-12 text-right">
  <button type="submit" class="btn btn-{{setting('theme_color')}}" ><i class="fa fa-save"></i> {{trans('lang.save')}} {{trans('lang.purchase_order')}}</button>
