    ...
    <div id="mid">
      <div id="table" style="display: flex;">
         ...
         <table style="width:50%;">
            <tr class="service">
               <td colspan="2" class="tableitem"><p class="itemtext">{{$sales_invoice->paymentmethod->name}} Payment</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Bill To</p></td>
               <td class="tableitem"><p class="itemtext">{{$sales_invoice->market->name}}</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Bill No</p></td>
               <td class="tableitem"><p class="itemtext">{{$sales_invoice->code}}</p></td>
            </tr>
         </table>
         ...
         <table style="width:50%;">
            <tr class="service">
               ...
               <td class="tableitem"><p class="itemtext">{{$sales_invoice->createdby->name}}</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Date</p></td>
               <td class="tableitem"><p class="itemtext">{{$sales_invoice->date->format('d/m/Y')}}</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Time</p></td>
               <td class="tableitem"><p class="itemtext">{{$sales_invoice->created_at->format('H:i:s')}}</p></td>
            </tr>
         </table>
               ...
               <div id="table">
                  <table>
                     ...
                     <tr class="tabletitle">
                        ...
                        <td class="payment text-right"><b>{{number_format($sales_invoice->sub_total,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right">Discount</td>
                        <td class="payment text-right"><b>{{number_format($sales_invoice->discount_total,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right">GST</td>
                        <td class="payment text-right"><b>{{number_format($sales_invoice->tax_total,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right">Delivery Charge</td>
                        <td class="payment text-right"><b>{{number_format($sales_invoice->delivery_charge,2,'.','')}}</b></td>
                     </tr>

                     @if($sales_invoice->redeempoints)
                        <tr class="tabletitle">
                          <td colspan="3" class="Rate text-right"> Redeem {{$sales_invoice->redeempoints->points}} Points </td>
                          <td class="payment text-right"><b>{{number_format($sales_invoice->redeempoints->amount,2,'.','')}}</b></td>
                        </tr>
                     @endif

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right"><b>Net Amount</b></td>
                        <td class="payment text-right"><b>{{number_format($sales_invoice->total,2,'.','')}}</b></td>
                     </tr>
