    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Sales Invoice List</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-list mr-2"></i>Sales Invoice List</a>
        </li>
        @can('salesInvoice.create')
        <li class="nav-item">
          <a class="nav-link" id="new-invoice" href="{!! route('salesInvoice.create') !!}">
            <i class="fa fa-plus mr-2"></i> Create Sales Invoice 
          </a>
        </li>
        @endcan
