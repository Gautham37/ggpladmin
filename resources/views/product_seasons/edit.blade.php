  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{!! route('productSeasons.create') !!}"><i class="fa fa-plus mr-2"></i>Create Product Season</a>
        </li>
        @endcan
        @can('productSeasons.edit')
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-edit mr-2"></i>Edit Product Season</a>
        </li>
        @endcan
      </ul>
    </div>
    ...
    <div class="card-body">
      {!! Form::model($product_season, ['route' => ['productSeasons.update', $product_season->id], 'method' => 'patch']) !!}
      <div class="row">
