    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{!! route('vendorStock.index') !!}"> Vendor Stock </a>
          </li>
          <li class="breadcrumb-item active">Edit Vendor Stock</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        @endcan
        @can('vendorStock.create')
        <li class="nav-item">
          <a class="nav-link" href="{!! route('vendorStock.create') !!}"><i class="fa fa-plus mr-2"></i>Create Vendor Stock</a>
        </li>
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>Edit Vendor Stock</a>
        </li>
      </ul>
    </div>
    
    <div class="card-body">
      {!! Form::model($vendor_stock, ['route' => ['vendorStock.update', $vendor_stock->id], 'method' => 'patch', 'class' => 'vendor-stock-form']) !!}
      <div class="row">
        @include('vendor_stock.fields')
      </div>
      {!! Form::close() !!}
      <div class="clearfix"></div>
    </div>
