...
<head>
   ...
   <title>{{$vendor_stock->code.'-'.$vendor_stock->market->name}}</title>
</head>
<body>
      ...
      <div class="invoice_page_original" style="font-size:12px;background-color:#f4f4f533;">
         <div class="invoice_page1">
            <table style="width: auto; background-color:#f4f4f533;">
               <tr>
                  <td style="border: 0px solid #000; padding: 3px;"><b>Vendor Supply</b></td>
            ...
            <table style="width: 100%; line-height:15px;" class="pdf_div1" cellpadding="15">
               <tr>
                  <td width="33%">
                     <b>Vendor Supply No : </b> 
                     {{$vendor_stock->code}}
                  </td>
                  <td width="33%">
                     <b>Date : </b> 
                     {{$vendor_stock->date->format('d M Y')}}
                  </td>
                  <td width="33%">
                     <b>Valid Date : </b> 
                     {{$vendor_stock->valid_date->format('d M Y')}}
                  </td>
               </tr>
            </table>
            <div class="pdf_whole" style="padding:10px;background-color:#f4f4f533;">
               ...
               <table style="width: 100%; line-height:15px;">
                  <tr>
                     <td width="33.33333%">  
                        <p><b>Bill To :</b></p>
                        <p><b>{{$vendor_stock->market->name}}</b></p>
                        <p>
                        <b>Address : </b> 
               ...
               <table class="table table-bordered view-table-custom-product-item" style="width: 100%; border-collapse: collapse;">
                  <tbody>      
                   ...
                   <tr>
                     ...
                     <td class="text-right">
                      {!! $currency !!} {{number_format($vendor_stock->sub_total,2,'.','')}}
                     </td>
                   </tr>
                   ...
                   @if($vendor_stock->tax_total > 0)
                     <tr>
                       ...
                       <td class="text-right">
                        {!! $currency !!} {{number_format($vendor_stock->tax_total,2,'.','')}}
                       </td>
                     </tr>
                   @endif
                   ...
                   @if($vendor_stock->discount_total > 0)
                     <tr>
                       ...
                       <td class="text-right">
                        {!! $currency !!} {{number_format($vendor_stock->discount_total,2,'.','')}}
                       </td>
                     </tr>
                   @endif
                   <?php /*/ ?>
                   ...
                   @if($vendor_stock->additional_charge > 0)
                     <tr>
                       <td colspan="4" class="font-weight-600 text-right"> {{$vendor_stock->additional_charge_description}} </td>
                       <td class="text-right">
                        {!! $currency !!} {{number_format($vendor_stock->additional_charge,2,'.','')}}
                       </td>
                     </tr>
                   @endif
                   ...
                   @if($vendor_stock->delivery_charge > 0)
                     <tr>
                       ...
                       <td class="text-right">
                        {!! $currency !!} {{number_format($vendor_stock->delivery_charge,2,'.','')}}
                       </td>
                     </tr>
                   @endif
                   ...
                   <tr>
                     ...
                     <td class="text-right">
                       <b>{!! $currency !!} {{number_format($vendor_stock->total,2,'.','')}}</b>
                     </td>
                   </tr>
                   ...
                   @if($vendor_stock->amount_due > 0)
                     <tr>
                       ...
                       <td class="text-right">
                         <b>{!! $currency !!} {{number_format($vendor_stock->amount_due,2,'.','')}}</b>
                       </td>
                     </tr>
                   @endif
                   <?php /*/ ?>
                  ...
                  <tr>
                     <td width="50%">
                        ...
                        <p>
                           ...
                           {!!$vendor_stock->terms_and_conditions!!}
                        </p>
                     </td>
