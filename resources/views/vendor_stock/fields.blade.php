    ...
    <div class="row" style="margin-top:20px;">
      ...
      @include('layouts.invoice_header')
        ...
        <div class="col-md-4 mt-4">
          ...
          <div class="form-group row">
            {!! Form::label('code', 'Vendor Stock No', ['class' => 'label-left col-md-4 control-label text-left']) !!}
            {!! Form::text('code', isset($vendor_stock_no) ? $vendor_stock_no : null ,  ['class' => 'col-md-8 form-control']) !!}
          </div>

          <div class="form-group row">
            {!! Form::label('date', 'Date', ['class' => 'label-left col-md-4 control-label text-left']) !!}
            {!! Form::text('date', isset($vendor_stock) ? $vendor_stock->date->format('d-m-Y') : date('d-m-Y'),  ['class' => 'col-md-8 form-control datepicker', 'readonly' => 'readonly']) !!}
          </div>

          <div class="form-group row">
            {!! Form::label('valid_date', 'Valid Date', ['class' => 'label-left col-md-4 control-label text-left']) !!}
            {!! Form::text('valid_date', isset($vendor_stock) ? $vendor_stock->valid_date->format('d-m-Y') : date('d-m-Y', time() + (86400 * 15)),  ['class' => 'col-md-8 form-control datepicker', 'readonly' => 'readonly']) !!}
          </div>
      ...
      <div class="col-md-12">
          <table id="salesItems" class="table table-bordered tbl-product-details">
            ...
            <tbody class="vendor-stock-items"></tbody>
            <!-- <tfoot>
    ...
    <div class="row">  
      ...
      <div class="col-md-7">
        <div class="col-md-12">
          ...
          {!! Form::textarea('description', null, ['class' => 'form-control','placeholder'=> "Notes"]) !!}      
        </div>
        <?php /*/ ?>
        <div class="col-md-12"> 
          {!! Form::label('terms_and_conditions', 'Terms and Conditions', ['class' => 'control-label text-left']) !!}
          {!! Form::textarea('terms_and_conditions', isset($vendor_stock) ? null : setting('app_invoice_terms_and_conditions'), ['class' => 'form-control']) !!}
        </div>
        <?php /*/ ?>
      </div>
...
<div class="form-group col-12 text-right">
  <button type="submit" class="btn btn-{{setting('theme_color')}} vendor-stock-form-submit" ><i class="fa fa-save"></i> Save Vendor Stock</button>
  <a href="{!! route('vendorStock.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> Cancel </a>
</div>
...
<script>
  ...
  function cartarrayToTable() {
    ...
    $(".vendor-stock-items").html(in_html);
  ...
  @if(isset($vendor_stock))
    ...
    $(document).ready(function() {
      ...
      var url   = '{!!route('vendorStock.show',$vendor_stock->id)!!}';
      var token = "{{ csrf_token() }}";
      $.ajax({
          type: 'GET',
          data: {
