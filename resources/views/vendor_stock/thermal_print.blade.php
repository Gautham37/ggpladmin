      ...
      <div id="table" style="display: flex;">
         ...
         <table style="width:50%;">
            <tr class="service">
               ...
               <td class="tableitem"><p class="itemtext">{{$vendor_stock->market->name}}</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Bill No</p></td>
               <td class="tableitem"><p class="itemtext">{{$vendor_stock->code}}</p></td>
            </tr>
         </table>
         ...
         <table style="width:50%;">
            <tr class="service">
               ...
               <td class="tableitem"><p class="itemtext">{{$vendor_stock->createdby->name}}</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Date</p></td>
               <td class="tableitem"><p class="itemtext">{{$vendor_stock->date->format('d/m/Y')}}</p></td>
            </tr>
            <tr class="service">
               <td class="tableitem"><p class="itemtext">Time</p></td>
               <td class="tableitem"><p class="itemtext">{{$vendor_stock->created_at->format('H:i:s')}}</p></td>
            </tr>
         </table>
               ...
               <div id="table">
                  <table>
                     ...
                     <tr class="tabletitle">
                        ...
                        <td class="payment text-right"><b>{{number_format($vendor_stock->sub_total,2,'.','')}}</b></td>
                     </tr>
                     <?php /*/ ?>
                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right">Discount</td>
                        <td class="payment text-right"><b>{{number_format($vendor_stock->discount_total,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right">GST</td>
                        <td class="payment text-right"><b>{{number_format($vendor_stock->tax_total,2,'.','')}}</b></td>
                     </tr>
                     <?php /*/ ?>
   
                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right">Delivery Charge</td>
                        <td class="payment text-right"><b>{{number_format($vendor_stock->delivery_charge,2,'.','')}}</b></td>
                     </tr>

                     <tr class="tabletitle">
                        <td colspan="3" class="Rate text-right"><b>Net Amount</b></td>
                        <td class="payment text-right"><b>{{number_format($vendor_stock->total,2,'.','')}}</b></td>
                     </tr>
