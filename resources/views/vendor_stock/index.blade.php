  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-list mr-2"></i>Vendor Stock List</a>
        </li>
        @can('vendorStock.create')
        <li class="nav-item">
          <a class="nav-link" id="new-invoice" href="{!! route('vendorStock.create') !!}">
            <i class="fa fa-plus mr-2"></i> Create Vendor Stock 
          </a>
        </li>
        @endcan
