  ...
  <div class="card">
    ...
    <div class="card-body">
      <div class="row">
       ...
       <div class="col-md-3 form-group">
              {!! Form::select('payment_method', $payment_methods, isset($_GET['payment_method']) ? $_GET['payment_method'] : null , ['class' => 'select2 form-control payment_method', 'onchange' => 'cb(start, end)' ]) !!}
          </div>
      </div>    
...
<script type="text/javascript">
    ...
    function cb(start, end) {
        ...
        location.href='?start_date='+start_date+'&end_date='+end_date+'&payment_method='+payment_method;
    }
    //function cb1() {}
    //function cb2() {}
