            ...
            <div class="row custom-from-css">
                <h5 class="col-12 pb-4"><i class="mr-3 fa fa-map"></i>{!! trans('lang.app_setting_google_maps_key') !!}</h5>
                    ...
                    <div class="form-group col-md-6">
                        {!! Form::label('google_maps_key', trans('lang.app_setting_google_maps_key'), ['class' => ' control-label text-left']) !!}
                    ...
                    <!-- Theme Color Field -->
                    <div class="form-group col-md-6">
                        {!! Form::label('distance_unit', trans("lang.app_setting_distance_unit"),['class' => ' control-label text-left']) !!}
                ...
                <div class="form-group col-6">
                    {!! Form::label('mobile_language', trans("lang.app_setting_mobile_language"),['class' => ' control-label text-left']) !!}
                ...
                <div class="form-group row col-6 " style="margin-top:7px;">
                    {!! Form::label('enable_version', trans('lang.app_setting_enable_version'),['class' => 'col-3 control-label text-right']) !!}
