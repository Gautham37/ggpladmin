        ...
        <div class="card-body">
            ...
            <div class="row custom-from-css">
                ...
                <div class="form-group col-6">
                    {!! Form::label('home_section_'.$i, trans("lang.app_setting_mobile_section_desc")." - $i",['class' => ' control-label']) !!}
                        ...
                        'special_offer_heading' => 'Special Offers Heading',
                        ...
                        'standard_products_heading' => trans('lang.app_setting_mobile_standard_products_heading'),
                        'standard_products' => trans('lang.app_setting_mobile_standard_products'),
                        'organic_products_heading' => trans('lang.app_setting_mobile_organic_products_heading'),
                        'organic_products' => trans('lang.app_setting_mobile_organic_products'),
                        'gmo_products_heading' => trans('lang.app_setting_mobile_gmo_products_heading'),
                        'gmo_products' => trans('lang.app_setting_mobile_gmo_products'),
                        'high_volume_products_heading' => trans('lang.app_setting_mobile_high_volume_products_heading'),
                        'high_volume_products' => trans('lang.app_setting_mobile_high_volume_products'),
                        'confectionaries_heading' => trans('lang.app_setting_mobile_confectionaries_heading'),
                        'confectionaries' => trans('lang.app_setting_mobile_confectionaries'),
                        'non_gmo_products_heading' => trans('lang.app_setting_mobile_non_gmo_products_heading'),
                        'non_gmo_products' => trans('lang.app_setting_mobile_non_gmo_products'),
                        'value_added_products_heading' => trans('lang.app_setting_mobile_value_added_products_heading'),
                        'value_added_products' => trans('lang.app_setting_mobile_value_added_products'),
                        ]
