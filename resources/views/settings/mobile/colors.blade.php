        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-6">
                    {!! Form::label('main_color', trans("lang.app_setting_main_color"), ['class' => ' control-label text-right']) !!}
                ...
                <div class="form-group col-6">
                    {!! Form::label('main_dark_color', trans("lang.app_setting_main_dark_color"), ['class' => ' control-label text-right']) !!}
                    <div id="main-colorpicker" class="input-group colorpicker-component">
                ...
                <!-- second_color Field -->
                <div class="form-group col-6">
                    {!! Form::label('second_color', trans("lang.app_setting_second_color"), ['class' => ' control-label text-right']) !!}
                    <div id="main-colorpicker" class="input-group colorpicker-component">
                ...
                <div class="form-group col-6">
                    {!! Form::label('second_dark_color', trans("lang.app_setting_second_dark_color"), ['class' => ' control-label text-right']) !!}
                    <div id="main-colorpicker" class="input-group colorpicker-component">
                ...
                <!-- accent_color Field -->
                <div class="form-group col-6">
                    {!! Form::label('accent_color', trans("lang.app_setting_accent_color"), ['class' => ' control-label text-right']) !!}
                    <div id="main-colorpicker" class="input-group colorpicker-component">
                ...
                <div class="form-group col-6">
                    {!! Form::label('accent_dark_color', trans("lang.app_setting_accent_dark_color"), ['class' => ' control-label text-right']) !!}
                    <div id="main-colorpicker" class="input-group colorpicker-component">
                ...
                <div class="form-group col-6">
                    {!! Form::label('scaffold_dark_color', trans("lang.app_setting_scaffold_dark_color"), ['class' => ' control-label text-right']) !!}
                    <div id="main-colorpicker" class="input-group colorpicker-component">
                ...
                <div class="form-group col-6">
                    {!! Form::label('scaffold_color', trans("lang.app_setting_scaffold_color"), ['class' => ' control-label text-right']) !!}
                    <div id="main-colorpicker" class="input-group colorpicker-component">
