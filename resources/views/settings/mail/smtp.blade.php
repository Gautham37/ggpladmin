            ...
            <div class="row">
                ...
                {!! Form::hidden('mail_driver','smtp') !!}
                    ...
                    <div class="form-group col-md-6">
                        {!! Form::label('mail_host', trans("lang.app_setting_mail_host"), ['class' => 'col-4 control-label text-left']) !!}
                    ...
                    <!-- mail_port Field -->
                    <div class="form-group col-md-6 ">
                        {!! Form::label('mail_port', trans("lang.app_setting_mail_port"), ['class' => 'col-4 control-label text-left']) !!}
                    ...
                    <!-- Lang Field -->
                    <div class="form-group col-md-6 ">
                        {!! Form::label('mail_encryption', trans("lang.app_setting_mail_encryption"),['class' => 'col-4 control-label text-left']) !!}
                    ...
                    <!-- mail_username Field -->
                    <div class="form-group col-md-6 ">
                        {!! Form::label('mail_username', trans("lang.app_setting_mail_username"), ['class' => 'col-4 control-label text-left']) !!}
                    ...
                    <!-- mail_password Field -->
                    <div class="form-group col-md-6 ">
                        {!! Form::label('mail_password', trans("lang.app_setting_mail_password"), ['class' => 'col-4 control-label text-left']) !!}
                    ...
                    <div class="form-group col-md-6 ">
                        {!! Form::label('mail_from_address', trans("lang.app_setting_mail_from_address"), ['class' => 'col-4 control-label text-left']) !!}
                    ...
                    <div class="form-group col-md-6 ">
                        {!! Form::label('mail_from_name', trans("lang.app_setting_mail_from_name"), ['class' => 'col-4 control-label text-left']) !!}
