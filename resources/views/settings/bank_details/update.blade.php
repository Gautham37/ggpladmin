            ...
            <div class="row custom-from-css">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group col-md-12">
                        {!! Form::label('app_bank_bankname', trans("lang.app_bank_bankname"), ['class' => 'control-label text-left']) !!}
                    ...
                    <div class="form-group col-md-12">
                        {!! Form::label('app_bank_account_number', trans("lang.app_bank_account_number"), ['class' => 'control-label text-left']) !!}
                    ...
                    <div class="form-group col-md-12">
                        {!! Form::label('app_bank_ifsc_code', trans("lang.app_bank_ifsc_code"), ['class' => 'control-label text-left']) !!}
                    ...
                    <div class="form-group col-md-12">
                        {!! Form::label('app_bank_bankbranch', trans("lang.app_bank_bankbranch"), ['class' => 'control-label text-left']) !!}
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group col-md-12">
                        {!! Form::label('app_upi_id', trans("lang.app_upi_id"), ['class' => 'control-label text-left']) !!}
                    ...
                    <!-- App Logo Field -->
                    <div class="form-group col-md-12">
                        {!! Form::label('app_upi_code', trans("lang.app_upload_upi_code"), ['class' => 'control-label text-left']) !!}
