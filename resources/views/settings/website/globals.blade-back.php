            ...
            <div class="row">
                <div style="flex: 50%;max-width: 100%;padding: 0 4px;" class="column">
                    ...
                    <div class="form-group row">
                        {!! Form::label('app_facebook_url', trans("lang.app_facebook_url"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        {!! Form::label('app_instagram_url', trans("lang.app_instagram_url"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        {!! Form::label('app_linkedin_url', trans("lang.app_linkedin_url"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        {!! Form::label('app_twitter_url', trans("lang.app_twitter_url"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        {!! Form::label('app_website_mobile', trans("lang.app_website_mobile"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        {!! Form::label('app_website_email', trans("lang.app_website_email"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        {!! Form::label('app_website_android_url', trans("lang.app_website_android_url"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        {!! Form::label('app_website_ios_url', trans("lang.app_website_ios_url"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
