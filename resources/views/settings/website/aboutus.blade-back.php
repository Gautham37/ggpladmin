            ...
            <div class="row">
                <div style="flex: 100%;max-width: 100%;padding: 0 4px;" class="column">
                    ...
                    <div class="form-group row ">
                      {!! Form::label('app_website_aboutus', trans("lang.app_website_aboutus"), ['class' => 'col-2 control-label text-right']) !!}
                      <div class="col-10">
                        {!! Form::textarea('app_website_aboutus', setting('app_website_aboutus'), ['class' => 'form-control','placeholder'=>
                         trans("lang.app_website_aboutus_placeholder")  ]) !!}
                        <div class="form-text text-muted">{{ trans("lang.app_website_aboutus_help") }}</div>
                      </div>
                    </div>
