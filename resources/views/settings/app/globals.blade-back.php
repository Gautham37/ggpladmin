        ...
        <div class="card-body">
            ...
            <div class="row">
                <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
                    ...
                    <div class="form-group row">
                        {!! Form::label('app_invoice_prefix', trans("lang.app_setting_app_invoice_prefix"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        {!! Form::label('app_store_latitude', trans("lang.app_store_latitude"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                    ...
                    <div class="form-group row">
                        {!! Form::label('app_store_longitude', trans("lang.app_store_longitude"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                    ...
                    <div class="form-group row ">
                      {!! Form::label('app_invoice_terms_and_conditions', trans("lang.app_setting_terms_and_conditions"), ['class' => 'col-4 control-label text-right']) !!}
                      <div class="col-8">
                ...
                <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
                    ...
                    <!-- App Signature Field -->
                    <div class="form-group row">
                        {!! Form::label('app_invoice_signature', trans("lang.upload_app_invoice_signature"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
