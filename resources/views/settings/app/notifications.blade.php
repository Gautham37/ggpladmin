...
@section('settings_content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="custom-from-css row">
                <!-- <h5 class="col-12 pb-4"><i class="mr-3 fa fa-bell"></i>{!! trans('lang.app_setting_notifications') !!}</h5> -->
                <!-- 'Boolean enable_facebook Field' -->
                <div class="form-group col-md-12 custom-checkbx">
                    <div class="row"> 
                    {!! Form::label('enable_notifications', trans('lang.app_setting_enable_notifications'),['class' => 'col-md-3 control-label text-left']) !!}
                ...
                <div class="form-group col-md-12">
                    {!! Form::label('fcm_key', trans('lang.app_setting_fcm_key'), ['class' => ' control-label text-left']) !!}
                ...
                <div class="form-group col-md-6">
                    {!! Form::label('firebase_api_key', trans('lang.app_setting_firebase_api_key'), ['class' => ' control-label text-left']) !!}
                ...
                <div class="form-group col-md-6">
                    {!! Form::label('firebase_auth_domain', trans('lang.app_setting_firebase_auth_domain'), ['class' => ' control-label text-left']) !!}
                ...
                <div class="form-group col-md-6">
                    {!! Form::label('firebase_database_url', trans('lang.app_setting_firebase_database_url'), ['class' => ' control-label text-left']) !!}
                ...
                <div class="form-group col-md-6">
                    {!! Form::label('firebase_project_id', trans('lang.app_setting_firebase_project_id'), ['class' => ' control-label text-left']) !!}
                ...
                <div class="form-group col-md-6">
                    {!! Form::label('firebase_storage_bucket', trans('lang.app_setting_firebase_storage_bucket'), ['class' => ' control-label text-left']) !!}
                ...
                <div class="form-group col-md-6">
                    {!! Form::label('firebase_messaging_sender_id', trans('lang.app_setting_firebase_messaging_sender_id'), ['class' => ' control-label text-left']) !!}
                ...
                <div class="form-group col-md-6">
                    {!! Form::label('firebase_app_id', trans('lang.app_setting_firebase_app_id'), ['class' => ' control-label text-left']) !!}
                ...
                <div class="form-group col-md-6">
                    {!! Form::label('firebase_measurement_id', trans('lang.app_setting_firebase_measurement_id'), ['class' => ' control-label text-left']) !!}
