        ...
        <div class="card-body">
            ...
            <div class="row custom-from-css">
                ...
                <div class="form-group col-md-6">
                    {!! Form::label('default_tax', trans('lang.app_setting_default_tax'), ['class' => ' control-label text-left']) !!}
                ...
                <div class="form-group col-md-6">
                    {!! Form::label('default_currency', trans('lang.app_setting_default_currency'), ['class' => 'control-label text-left']) !!}
                ...
                <div class="form-group col-md-6 custom-checkbx">
                    <div class="row"> 
                    {!! Form::label('currency_right', trans('lang.app_setting_currency_right'),['class' => 'col-md-4 control-label text-left']) !!}
                    <div class="col-md-8 checkbox icheck">
