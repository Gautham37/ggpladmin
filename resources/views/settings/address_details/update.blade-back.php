    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                <li class="nav-item">
                    <a class="nav-link active" href="{!! url('settings/addressDetails') !!}"><i class="fa fa-list mr-2"></i>{{trans('lang. ,')}}</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-12">
                    {!! Form::label('app_store_address_line_1', trans("lang.app_store_address_line_1"), ['class' => 'control-label text-right']) !!}
                    <div class="col-8">
                ...
                <div class="form-group col-md-12">
                    {!! Form::label('app_store_address_line_2', trans("lang.app_store_address_line_2"), ['class' => 'control-label text-right']) !!}
                    <div class="col-8">
                ...
                <div class="form-group col-md-12">
                    {!! Form::label('app_store_city', trans("lang.app_store_city"), ['class' => 'control-label text-right']) !!}
                    <div class="col-8">
                ...
                <div class="form-group col-md-12">
                    {!! Form::label('app_store_state', trans("lang.app_store_state"), ['class' => 'control-label text-right']) !!}
                    <div class="col-8">
                ...
                <div class="form-group col-md-12">
                    {!! Form::label('app_store_country', trans("lang.app_store_country"), ['class' => 'control-label text-right']) !!}
                    <div class="col-8">
                ...
                <div class="form-group col-md-12">
                    {!! Form::label('app_store_pincode', trans("lang.app_store_pincode"), ['class' => 'control-label text-right']) !!}
                    <div class="col-8">
                ...
                <div class="form-group col-md-12">
                    {!! Form::label('app_store_phone_no', trans("lang.app_store_phone_no"), ['class' => 'control-label text-right']) !!}
                    <div class="col-8">
                ...
                <div class="form-group col-md-12">
                    {!! Form::label('app_store_gstin', trans("lang.app_store_gstin"), ['class' => 'control-label text-right']) !!}
                    <div class="col-8">
