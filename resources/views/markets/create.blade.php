...
<div class="content">
  ...
  <div class="card">
    ...
    <div class="card-body">
        {!! Form::open(['route' => 'markets.store', 'class' => 'party-form']) !!}
        <div class="row">
  ...
  @include('layouts.modal.party_stream_modal')  
  @include('layouts.modal.party_type_modal')
  @include('layouts.modal.party_sub_type_modal')
  @include('layouts.modal.customer_group_modal')
  @include('layouts.modal.designation_modal')
...
<script>
  ...
  //$("#phone").inputmask("(999)99-999-999");
</script>
...
function initialize() {
    if (stillPresent == false) {
        ...
        $("#latitude").val($('#us2-lat').val());
        $("#longitude").val($('#us2-lon').val());        
        $('#myModal').modal('hide');
    });
    }
}
