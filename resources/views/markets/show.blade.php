    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">{{trans('lang.market_show')}}</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        @endcan
        <li class="nav-item">
          <a class="nav-link active" href="{!! route('markets.view', $market->id) !!}"><i class="fa fa-sticky-note-o mr-2"></i>{{trans('lang.market_view')}}</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
...
<script>
    $(document).ready(function() {
        $(".parties").change(function(e){
			var val = $(this).val();
			if(val != '' && val != undefined){
				window.location.href= "{!!url('markets/view')!!}/" + val;
			}
			e.preventDefault();
		});
    });
