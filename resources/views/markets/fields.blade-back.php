...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        {!! Form::label('name', trans("lang.market_name"), ['class' => 'col-3 control-label text-right required']) !!}
        <div class="col-9">
    ...
    <!-- Email Field -->
    <div class="form-group row ">
        {!! Form::label('email', trans("lang.market_email"), ['class' => 'col-3 control-label text-right required']) !!}
        <div class="col-9">
...
<div class="col-12 custom-field-container">
    ...
    <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
        ...
        <?php /*/ ?>
        <div class="form-group row ">
            {!! Form::label('active', trans("lang.market_active"),['class' => 'col-4 control-label text-right']) !!}
            <div class="checkbox icheck">
